...
DSTDIR=etc/orderer-org1
mkdir -p $DSTDIR
cp $DATADIR/orderer.yaml $DSTDIR/
cp -rp artifacts/crypto-config/ordererOrganizations/org1.example.com/orderers/orderer.org1.example.com/* $DSTDIR/
cp artifacts/crypto-config/ordererOrganizations/example.com/msp/tlscacerts/tlsca.example.com-cert.pem $DSTDIR/tls/
cp artifacts/crypto-config/peerOrganizations/org1.example.com/msp/tlscacerts/tlsca.org1.example.com-cert.pem $DSTDIR/tls/
cp artifacts/crypto-config/peerOrganizations/org2.example.com/msp/tlscacerts/tlsca.org2.example.com-cert.pem $DSTDIR/tls/

DSTDIR=etc/orderer-org2
mkdir -p $DSTDIR
cp $DATADIR/orderer.yaml $DSTDIR/
cp -rp artifacts/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer.org2.example.com/* $DSTDIR/
cp artifacts/crypto-config/ordererOrganizations/example.com/msp/tlscacerts/tlsca.example.com-cert.pem $DSTDIR/tls/
cp artifacts/crypto-config/peerOrganizations/org1.example.com/msp/tlscacerts/tlsca.org1.example.com-cert.pem $DSTDIR/tls/
cp artifacts/crypto-config/peerOrganizations/org2.example.com/msp/tlscacerts/tlsca.org2.example.com-cert.pem $DSTDIR/tls/
...
DSTDIR=etc/prometheus
mkdir -p $DSTDIR
cp $DATADIR/prometheus.yml $DSTDIR/

DSTDIR=etc/grafana
mkdir -p $DSTDIR
cp $DATADIR/grafana-datasource.yaml $DSTDIR/datasource.yaml
