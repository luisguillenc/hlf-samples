...
msg "generating root ca ${ORG_CODE}-rca-tls for $ORG_NAME"
createRootCA ${ORG_CODE}-rca-tls "$ORG_NAME" || die "can't create root CA TLS"

msg "generating intermediate ${ORG_CODE}-ica-tls for $ORG_NAME"
createIntermediateCA ${ORG_CODE}-ica-tls "$ORG_NAME" ${ORG_CODE}-rca-tls || die "can't create intermediate CA TLS"
...
msg "generating root ca ${ORG_CODE}-rca-msp for $ORG_NAME"
createRootCA ${ORG_CODE}-rca-msp "$ORG_NAME" || die "can't create root CA MSP"

msg "generating intermediate ${ORG_CODE}-ica-msp for $ORG_NAME"
createIntermediateCA ${ORG_CODE}-ica-msp "$ORG_NAME" ${ORG_CODE}-rca-msp || die "can't create intermediate CA MSP"
