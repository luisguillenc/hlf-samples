...
cp artifacts/crypto-config/ordererOrganizations/example.com/tls/ca.crt $DSTDIR/tls/tlsca.example.com-cert.pem
cp artifacts/crypto-config/peerOrganizations/org1.example.com/tls/ca.crt $DSTDIR/tls/tlsca.org1.example.com-cert.pem
cp artifacts/crypto-config/peerOrganizations/org2.example.com/tls/ca.crt $DSTDIR/tls/tlsca.org2.example.com-cert.pem
