...
echo "getting Chaincode ID of $CC_LABEL in org1"
PACKAGE_ID=`docker exec -e CORE_PEER_TLS_CLIENTAUTHREQUIRED=true \
            -e CORE_PEER_TLS_CLIENTCERT_FILE=tls/client.crt \
            -e CORE_PEER_TLS_CLIENTKEY_FILE=tls/client.key  \
    ${COMPOSE_PROJECT_NAME}_cli-org1 ./getChaincodeID.sh $CC_LABEL`
...
PACKAGE_ID=`docker exec -e CORE_PEER_TLS_CLIENTAUTHREQUIRED=true \
            -e CORE_PEER_TLS_CLIENTCERT_FILE=tls/client.crt \
            -e CORE_PEER_TLS_CLIENTKEY_FILE=tls/client.key  \
    ${COMPOSE_PROJECT_NAME}_cli-org2 ./getChaincodeID.sh $CC_LABEL`
